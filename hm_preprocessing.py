...
Original file is located at
    https://colab.research.google.com/drive/1HW-A7l37-wJeE6_Q8WcD0kbMXZf--Qze
"""

# TODO:
# 1. Continue EDA (Country and Genre impact)
# 2. Feature engineering
# 3. Select models (6 regression models in total)
# 4. Select features, preproccess data,
...
mlp = MLPRegressor(hidden_layer_sizes=(64, 16), activation='relu', learning_rate_init=0.001,
